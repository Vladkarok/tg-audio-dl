...
- **Hardened Docker** — rootless (UID 1000), `cap_drop: ALL`, read-only filesystem, resource limits
...
mkdir -p cache && sudo chown 1000:1000 cache
docker compose up -d
```
...
Python 3.13 · python-telegram-bot · yt-dlp · pydantic-settings · aioboto3 · Docker
