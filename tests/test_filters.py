...
class TestMediaURLFilter:
    ...
    def test_matches_youtu_be_url(self):
        msg = make_message("https://youtu.be/dQw4w9WgXcQ")
        assert self.f.filter(msg) is True

    def test_matches_youtube_url_in_sentence(self):
    ...
    def test_matches_shorts_url(self):
    ...
    def test_matches_soundcloud_set(self):
        msg = make_message("https://soundcloud.com/rick-astley/sets/greatest-hits")
        assert self.f.filter(msg) is True

    def test_matches_on_soundcloud_short_url(self):
